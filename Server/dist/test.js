...
async function testServer() {
    try {
        ...
        const recommendations = await (0, node_fetch_1.default)(`${BASE_URL}/recommendations?limit=2`);
        ...
        const archive = await (0, node_fetch_1.default)(`${BASE_URL}/recommendations/${recommendationId}/archive`, {
            method: 'POST'
        });
        ...
        const archived = await (0, node_fetch_1.default)(`${BASE_URL}/recommendations/archive`);
        ...
        const unarchive = await (0, node_fetch_1.default)(`${BASE_URL}/recommendations/${recommendationId}/unarchive`, {
            method: 'POST'
        });
        ...
        const login = await (0, node_fetch_1.default)(`${BASE_URL}/login`, {
            method: 'POST',
            headers: {
        ...
        if (loginData?.token) {
            ...
            const authed = await (0, node_fetch_1.default)(`${BASE_URL}/recommendations`, {
                headers: {
                    // @ts-ignore
